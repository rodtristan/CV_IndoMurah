...
// Cheque/Giro Payment Status for Purchases - Track and manage supplier cheques
...
export default function PurchaseChequePage() {
  return <ChequePaymentPage type="PURCHASE" />;
}
