  ...
  return (
    <ListPage
      ...
      columns={[
        ...
        { key: "Jenis", label: "Jenis", render: (_, r) => (String(r.Code).startsWith("DBOUT") ? "DBOUT" : String(r.Code).startsWith("DBUSE") ? "DBUSE (dipakai)" : "DBIN") },
        ...
        { key: "RemainingAmount", label: "Sisa", align: "right", render: (v, r) => (String(r.Code).startsWith("DBIN") ? fmt(v) : "-") },
      ]}
    />
  );
}
