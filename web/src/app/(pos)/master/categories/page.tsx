...
export default function CategoriesPage() {
  ...
  return (
    <PageWrapper>
      <PageHeader title="Kategori" subtitle="Master kategori produk"
        actions={<Button variant="primary" icon={Plus} onClick={() => { setForm({ name: "", code: "", description: "" }); setShowForm(true); }}>Tambah</Button>} />

      <Card>
        <div className="mb-4 flex gap-4">
          <Input placeholder="Cari kategori..." value={search} onChange={e => setSearch(e.target.value)} className="max-w-xs" leftIcon={Search} />
