...
> {
  ...
  // Contoh:
  //
  // async processTransaction(data: CreateLeaveBalanceDto, userId: string) {
  //   return this.prisma.$transaction(async (tx) => {
  //     // 1. Create record
  //     const result = await tx.LeaveBalance.create({ data });
  //
  //     // 2. Update related records
  //     // await tx.relatedModel.update(...);
  //
  //     // 3. Invalidate cache
  //     await this.redis.del('cache:leave-balance:*');
  //
  //     return result;
  //   });
  // }
