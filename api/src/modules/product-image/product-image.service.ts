...
> {
  ...
  // Contoh:
  //
  // async processTransaction(data: CreateProductImageDto, userId: string) {
  //   return this.prisma.$transaction(async (tx) => {
  //     // 1. Create record
  //     const result = await tx.ProductImage.create({ data });
  //
  //     // 2. Update related records
  //     // await tx.relatedModel.update(...);
  //
  //     // 3. Invalidate cache
  //     await this.redis.del('cache:product-image:*');
  //
  //     return result;
  //   });
  // }
