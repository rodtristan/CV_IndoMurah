...
> {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all point redemptions with OData query support' })
  ...
  @Post('bulk')
  async createBulk(@Body() dtos: CreatePointRedemptionDto[]) {
  ...
  @Patch('bulk')
  async patchBulk(@Body() body: { ids: number[]; data: Partial<UpdatePointRedemptionDto> }) {
    return super.patchBulk(body);
  }

  @Put()
  async upsert(@Body() body: { where: { id: number }; create: CreatePointRedemptionDto; update: Partial<UpdatePointRedemptionDto> }) {
