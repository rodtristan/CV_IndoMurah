...
@Injectable()
export class MonthlySalesSummaryService extends BaseService<
  any,
...
> {
  constructor(
    ...
    super(prisma, redis, queryService, {
      modelName: 'monthly-sales-summary',
      primaryKey: 'id',
  ...
  // Contoh:
  //
  // async processTransaction(data: CreateMonthlySalesSummaryDto, userId: string) {
  //   return this.prisma.$transaction(async (tx) => {
  //     // 1. Create record
  //     const result = await tx.MonthlySalesSummary.create({ data });
  //
  //     // 2. Update related records
  //     // await tx.relatedModel.update(...);
  //
  //     // 3. Invalidate cache
  //     await this.redis.del('cache:monthly-sales-summary:*');
  //
  //     return result;
  //   });
  // }
