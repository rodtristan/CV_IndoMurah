...
let JournalEntryController = class JournalEntryController extends base_controller_1.BaseController {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all JournalEntrys with OData query support' }),
    (0, swagger_1.ApiQuery)({ name: '$select', required: false, description: 'Select fields' }),
    (0, swagger_1.ApiQuery)({ name: '$include', required: false, description: 'Include relations: journal, account' }),
    ...
    (0, swagger_1.ApiQuery)({ name: '$search', required: false, description: 'Search: ' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get count of JournalEntrys' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], JournalEntryController.prototype, "getCount", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get JournalEntry by ID' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], JournalEntryController.prototype, "findById", null);
__decorate([
    (0, common_1.Get)('by/:field/:value'),
    (0, swagger_1.ApiOperation)({ summary: 'Get JournalEntry by field reference' }),
    ...
    __metadata("design:returntype", Promise)
], JournalEntryController.prototype, "findByField", null);
exports.JournalEntryController = JournalEntryController = __decorate([
    (0, swagger_1.ApiTags)('JournalEntry'),
