...
let CustomerDepositService = class CustomerDepositService extends base_service_1.BaseService {
    constructor(prisma, redis, queryService, autoJournal, ledger) {
        ...
        this.doc = new deposit_doc_helper_1.DepositDocHelper(prisma, autoJournal, ledger, 'customer');
    }
