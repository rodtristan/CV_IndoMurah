...
const budgeting_controller_1 = require("./budgeting-controller");
...
exports.BudgetingModule = BudgetingModule = __decorate([
    (0, common_1.Module)({
        controllers: [budgeting_controller_1.BudgetingController],
        providers: [budgeting_service_1.BudgetingService],
        exports: [budgeting_service_1.BudgetingService],
    })
], BudgetingModule);
