...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Unique category code' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Category icon' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ default: true, description: 'Is category active' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Unique category code' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
