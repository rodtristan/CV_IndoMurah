...
exports.UpdateSalePaymentDto = exports.CreateSalePaymentDto = void 0;
...
], CreateSalePaymentDto.prototype, "ReferenceNumber", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Payment date', type: String }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateSalePaymentDto.prototype, "Date", void 0);
__decorate([
    ...
    __metadata("design:type", String)
], CreateSalePaymentDto.prototype, "InstrumentType", void 0);
__decorate([
...
], CreateSalePaymentDto.prototype, "UseDeposit", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Due date (cek/bg)', type: String }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateSalePaymentDto.prototype, "DueDate", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Notes' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateSalePaymentDto.prototype, "Notes", void 0);
class UpdateSalePaymentDto {
}
exports.UpdateSalePaymentDto = UpdateSalePaymentDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Payment method ID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], UpdateSalePaymentDto.prototype, "MethodID", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Payment amount' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], UpdateSalePaymentDto.prototype, "Amount", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Reference number' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSalePaymentDto.prototype, "ReferenceNumber", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Payment date', type: String }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], UpdateSalePaymentDto.prototype, "Date", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'CASH | CEK | BG | DEPOSIT (DEPOSIT = bayar memakai saldo deposit)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['CASH', 'CEK', 'BG', 'DEPOSIT']),
    __metadata("design:type", String)
], UpdateSalePaymentDto.prototype, "InstrumentType", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'true = bayar memakai saldo deposit (sama dengan InstrumentType DEPOSIT)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], UpdateSalePaymentDto.prototype, "UseDeposit", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Due date (cek/bg)', type: String }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], UpdateSalePaymentDto.prototype, "DueDate", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Notes' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSalePaymentDto.prototype, "Notes", void 0);
