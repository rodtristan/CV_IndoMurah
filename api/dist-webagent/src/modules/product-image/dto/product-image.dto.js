...
exports.QueryProductImageDto = exports.ProductImageResponseDto = exports.UpdateProductImageDto = exports.CreateProductImageDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'caption' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'isPrimary' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'url' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateProductImageDto.prototype, "caption", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'sortOrder' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'caption' }),
    __metadata("design:type", String)
], ProductImageResponseDto.prototype, "caption", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'sortOrder' }),
    __metadata("design:type", Number)
], ProductImageResponseDto.prototype, "sortOrder", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'isPrimary' }),
    __metadata("design:type", Boolean)
], ProductImageResponseDto.prototype, "isPrimary", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'product' }),
    __metadata("design:type", Object)
], ProductImageResponseDto.prototype, "product", void 0);
class QueryProductImageDto {
}
exports.QueryProductImageDto = QueryProductImageDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Fields to select' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryProductImageDto.prototype, "$select", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Relations to include' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryProductImageDto.prototype, "$include", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], QueryProductImageDto.prototype, "$skip", void 0);
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], QueryProductImageDto.prototype, "$take", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Search keyword' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryProductImageDto.prototype, "$search", void 0);
