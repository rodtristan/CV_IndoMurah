...
let CashOutService = class CashOutService extends base_service_1.BaseService {
    constructor(prisma, redis, queryService, autoJournal) {
        ...
        this.doc = new cash_doc_helper_1.CashDocHelper(prisma, autoJournal, 'out');
    }
...
exports.CashOutService = CashOutService = __decorate([
