...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'cashier01', description: 'Username (unique per company)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'cashier', description: 'Default: cashier' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
