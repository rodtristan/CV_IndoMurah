...
exports.QueryNotificationDto = exports.UpdateNotificationDto = exports.CreateNotificationDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Target user ID (omit for a broadcast notification visible to everyone)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Type code (SALE, PURCHASE, STOCK, PAYMENT, APPOINTMENT, REMINDER)', default: 'REMINDER' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateNotificationDto.prototype, "typeCode", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Reference type (e.g. Sale, Purchase, Product)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Mark as read/unread' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryNotificationDto.prototype, "$select", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Relations to include' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryNotificationDto.prototype, "$include", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], QueryNotificationDto.prototype, "$take", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Search keyword' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], QueryNotificationDto.prototype, "$search", void 0);
