...
export const POS_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    icon: "BarChart",
    children: [
      { id: 71, name: "Daftar Item", href: "/reports/master/items" },
      { id: 72, name: "Daftar Supplier", href: "/reports/master/suppliers" },
      { id: 73, name: "Daftar Pelanggan", href: "/reports/master/customers" },
      { id: 74, name: "Daftar Sales", href: "/reports/master/sales" },
      { id: 75, name: "Pembelian", href: "/reports/purchase/transactions" },
      { id: 76, name: "Pembelian Per Item", href: "/reports/purchase/per-item" },
      { id: 77, name: "Penjualan", href: "/reports/sale/transactions" },
      { id: 78, name: "Penjualan Per Item", href: "/reports/sale/per-item" },
      { id: 79, name: "Buku Hutang", href: "/reports/debt/sub-ledger" },
      { id: 710, name: "Hutang Per Transaksi", href: "/reports/debt/per-transaction" },
      { id: 711, name: "Buku Piutang", href: "/reports/receivable/sub-ledger" },
      { id: 712, name: "Piutang Per Transaksi", href: "/reports/receivable/per-transaction" },
    ],
  },
  {
    id: 8,
