...
// Mock sale orders data
const mockSaleOrders = [
  { id: 1, code: "SO240912001", date: "12/09/2024", customerName: "Andi Wijaya", dueDate: "19/09/2024", qty: 15, total: 850000, status: "pending" },
  { id: 2, code: "SO240912002", date: "12/09/2024", customerName: "Budi Santoso", dueDate: "19/09/2024", qty: 10, total: 450000, status: "draft" },
  { id: 3, code: "SO240912003", date: "12/09/2024", customerName: "CV Maju Jaya", dueDate: "19/09/2024", qty: 20, total: 1200000, status: "confirmed" },
  { id: 4, code: "SO240911001", date: "11/09/2024", customerName: "PT Sumber Rezeki", dueDate: "18/09/2024", qty: 25, total: 675000, status: "completed" },
  { id: 5, code: "SO240911002", date: "11/09/2024", customerName: "Toko Elektronik ABC", dueDate: "18/09/2024", qty: 8, total: 875000, status: "pending" },
];
...
export default function SaleOrdersPage() {
  ...
  const filteredData = mockSaleOrders.filter((p) =>
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "confirmed":
        return <span className="rounded-full px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-700">Dikonfirmasi</span>;
      case "completed":
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Penjualan / Pesanan Penjualan"
        subtitle="Kelola pesanan penjualan barang dagangan"
        actions={
          <div className="flex gap-2">
            ...
            <Button size="sm" className="bg-[#9C27B0] hover:bg-[#7B1FA2]">
              <Plus className="size-4 mr-2" /> Pesanan Baru
            </Button>
          </div>
        }
      />
