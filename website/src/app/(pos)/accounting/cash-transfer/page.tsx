...
// Mock cash transfer data
const mockCashTransfer = [
  { id: 1, code: "CT240912001", date: "12/09/2024", fromAccount: "Kas Besar", toAccount: "Bank BCA", description: "Setoran bank", amount: 1000000 },
  { id: 2, code: "CT240911001", date: "11/09/2024", fromAccount: "Bank BCA", toAccount: "Kas Kecil", description: "Penarikan ATM", amount: 500000 },
  { id: 3, code: "CT240910001", date: "10/09/2024", fromAccount: "Kas Besar", toAccount: "Bank Mandiri", description: "Transfer antar bank", amount: 750000 },
];
...
export default function CashTransferPage() {
  ...
  const filteredData = mockCashTransfer.filter((p) =>
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Accounting / Transfer Kas"
        subtitle="Kelola transfer antar akun kas"
        actions={
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 px-4 py-3">
          <div className="text-xs text-gray-500 mb-1">Akun Aktif</div>
          <div className="flex items-baseline gap-2">
            <span className="text-xl font-bold text-[#9C27B0]">5</span>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr className="text-xs text-gray-500 text-left">
                ...
                <th className="px-4 py-3 font-medium">Dari Akun</th>
                <th className="px-4 py-3 font-medium">Ke Akun</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {paginatedData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-700">{item.fromAccount}</td>
                  <td className="px-4 py-3 text-sm text-gray-700">{item.toAccount}</td>
