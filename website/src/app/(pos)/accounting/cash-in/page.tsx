...
// Mock cash in data
const mockCashIn = [
  { id: 1, code: "CI240912001", date: "12/09/2024", account: "Kas Besar", description: "Penerimaan dari penjualan", source: "Penjualan POS", amount: 850000 },
  { id: 2, code: "CI240912002", date: "12/09/2024", account: "Kas Kecil", description: "Pelunasan piutang customer", source: "Piutang", amount: 450000 },
  { id: 3, code: "CI240911001", date: "11/09/2024", account: "Bank BCA", description: "Transfer dari supplier", source: "Hutang Supplier", amount: 1250000 },
  { id: 4, code: "CI240911002", date: "11/09/2024", account: "Kas Besar", description: "Penerimaan lainnya", source: "Lainnya", amount: 200000 },
  { id: 5, code: "CI240910001", date: "10/09/2024", account: "Bank Mandiri", description: "Pembayaran customer", source: "Piutang", amount: 675000 },
];
...
export default function CashInPage() {
  ...
  const filteredData = mockCashIn.filter((p) =>
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Accounting / Kas Masuk"
        subtitle="Kelola transaksi kas masuk"
        actions={
          <div className="flex gap-2">
            ...
            <Button size="sm" className="bg-[#9C27B0] hover:bg-[#7B1FA2]">
              <Plus className="size-4 mr-2" /> Kas Masuk Baru
            </Button>
          </div>
        }
      />
      ...
      <div className="grid grid-cols-4 gap-4 mb-4">
        <div className="bg-white rounded-lg border border-gray-200 px-4 py-3">
          <div className="text-xs text-gray-500 mb-1">Total Kas Masuk</div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 px-4 py-3">
          <div className="text-xs text-gray-500 mb-1">Saldo Tersedia</div>
          <div className="flex items-baseline gap-2">
            <span className="text-xl font-bold text-green-600">{formatCurrency(totalAmount)}</span>
          </div>
        </div>
