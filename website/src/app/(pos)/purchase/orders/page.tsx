...
const mockPurchaseOrders = [
  { id: 1, code: "PO240912001", date: "12/09/2024", supplierName: "PT Sentosa Jaya", dueDate: "19/09/2024", qty: 15, total: 550000, status: "pending" },
  { id: 2, code: "PO240912002", date: "12/09/2024", supplierName: "CV Maju Bersama", dueDate: "19/09/2024", qty: 10, total: 450000, status: "draft" },
  { id: 3, code: "PO240912003", date: "12/09/2024", supplierName: "UD Sumber Rezeki", dueDate: "19/09/2024", qty: 20, total: 450000, status: "confirmed" },
  { id: 4, code: "PO240911001", date: "11/09/2024", supplierName: "PT Sentosa Jaya", dueDate: "18/09/2024", qty: 25, total: 1250000, status: "completed" },
  { id: 5, code: "PO240911002", date: "11/09/2024", supplierName: "Toko Elektronik ABC", dueDate: "18/09/2024", qty: 8, total: 875000, status: "pending" },
];
...
export default function PurchaseOrdersPage() {
  ...
  const filteredData = mockPurchaseOrders.filter((p) =>
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Pembelian / Pesanan Pembelian"
        subtitle="Kelola pesanan pembelian barang dagangan"
        actions={
