...
const mockPriceHistory = [
  { id: 1, code: "BRG001", name: "Mie Instan Indomie", category: "Makanan", oldPrice: 25000, newPrice: 28000, difference: 3000, date: "12/09/2024" },
  { id: 2, code: "BRG002", name: "Kopi Sachet", category: "Minuman", oldPrice: 40000, newPrice: 42000, difference: 2000, date: "12/09/2024" },
  { id: 3, code: "BRG003", name: "Sabun Mandi", category: "Sabun", oldPrice: 15000, newPrice: 15000, difference: 0, date: "11/09/2024" },
  { id: 4, code: "BRG004", name: "Shampo Botol", category: "Shampo", oldPrice: 35000, newPrice: 38000, difference: 3000, date: "11/09/2024" },
  { id: 5, code: "BRG005", name: "Mie Goreng", category: "Makanan", oldPrice: 30000, newPrice: 28000, difference: -2000, date: "10/09/2024" },
];
...
export default function PriceHistoryPage() {
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Pembelian / History Harga Beli"
        subtitle="Riwayat perubahan harga beli barang"
        actions={
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr className="text-xs text-gray-500 text-left">
                ...
                <th className="px-4 py-3 font-medium text-right">Harga Beli Lama</th>
                <th className="px-4 py-3 font-medium text-right">Harga Beli Baru</th>
              ...
              {paginatedData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className={cn(
                    ...
                    item.difference > 0 ? "text-red-600" : item.difference < 0 ? "text-green-600" : "text-gray-700"
                  )}>
