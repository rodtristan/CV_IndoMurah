...
const mockPurchaseReturns = [
  { id: 1, code: "RT240912001", purchaseCode: "PO240912001", date: "12/09/2024", supplierName: "PT Sentosa Jaya", qty: 5, total: 140000, status: "pending" },
  { id: 2, code: "RT240911001", purchaseCode: "PO240911001", date: "11/09/2024", supplierName: "CV Maju Bersama", qty: 3, total: 90000, status: "approved" },
  { id: 3, code: "RT240910001", purchaseCode: "PO240910001", date: "10/09/2024", supplierName: "UD Sumber Rezeki", qty: 2, total: 60000, status: "completed" },
  { id: 4, code: "RT240909001", purchaseCode: "PO240909001", date: "09/09/2024", supplierName: "Toko Elektronik ABC", qty: 1, total: 35000, status: "completed" },
];
...
export default function PurchaseReturnsPage() {
  ...
  const filteredData = mockPurchaseReturns.filter((p) =>
  ...
  return (
    <PageWrapper className="bg-gray-100">
      <PageTitle
        title="Pembelian / Retur Pembelian"
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr className="text-xs text-gray-500 text-left">
                ...
                <th className="px-4 py-3 font-medium">Kode Pembelian</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {paginatedData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-500">{item.purchaseCode}</td>
